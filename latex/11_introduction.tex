...
\section{Atoms and light}
	...
	% If the electric field has polarization $\varepsilon$ and propagates along $\kvec$ and there is a magnetic field in the $\vec{B}$ direction.
...
% Can potentially shoehorn the OBEs in here 
	...
	\todo{Add citations for dipole trap history}
...
\section{Interactions between atoms}
	...
	These reduced Penning ionization rates to the order of $5\times10^{-9}$ cm$^3$/s at large detunings, an improvement of almost a factor of twenty.
...
% \subsection{What is a BEC?}
	...
	\todo{I don't quite follow your arguments here...
	are you saying dilute gases may not be BECs, or that Penrose-Onsager theory may not be valid, or both?}
...
\subsection*{Bogoliubov theory}
	...
	The emergence of a condensate has many of the hallmarks of a classical phase transition: kinetic effects are necessary to redistribute energy and reach steady-state\footnote{\todo{Bose enhancement re: scattering into the	ground state.
	}}; a unique critical temperature $T_c$ exists; below $T_c$ an \emph{order parameter} takes on a nonzero value; and condensation is equivalent to the spontaneous breaking of a U(1) gauge symmetry \cite{yukalov11_symmetry}.
...
\subsection*{Harmonically trapped condensates}
	...
	\todo{The last couple of pages I feel you could add a little more insight in terms of simple physical pictures of what is going on behind some of the maths.
	 What you have isn't wrong and is perfectly fine as is, but a couple of simple physical insights can add a lot.
	}
